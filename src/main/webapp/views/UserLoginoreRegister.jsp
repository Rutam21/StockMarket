...
<div class="login-reg-panel">
		...
		<div class="white-panel">
			<div class="login-show">
				...
				<form:input path="userName" value="" type="text" placeholder="User Name"></form:input>
				<form:input path="password" value="" type="password" placeholder="Password"></form:input>
			...
			<div class="register-show">
				...
				<form:input path="phoneNumber" type="text" placeholder="phoneNumber" value=""></form:input>
